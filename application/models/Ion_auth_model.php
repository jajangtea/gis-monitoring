...
class Ion_auth_model extends CI_Model
{
    ...
    public function users_pelanggan($groups = null)
    {
        $this->trigger_events('users');
        ...
        if (isset($groups)) {
            ...
            if (isset($groups) && !empty($groups)) {
                ...
                $this->db->join($this->tables['profile_pelanggan'], $this->tables['profile_pelanggan'] . '.' . 'id_user' . '=' . $this->tables['users'] . '.id', 'left');
                $this->db->join($this->tables['hotspot'], $this->tables['hotspot'] . '.' . 'id' . '=' . $this->tables['profile_pelanggan'] . '.id_hotspot', 'left');
            }
    ...
    public function get_users_groups_pelanggan($id = false)
    {
        $this->trigger_events('get_users_group');
