...
?>
                    ...
                    <div class="form-group">
                        <label>DMA</label>
                        <select name="id_dma" class="form-control">
                            <?php foreach ($dma as $key => $value): ?>
                            <option value="<?=$value->id_dma?>"
                                <?php if ($profile_pelanggan->id_dma == $value->id_dma) {echo 'selected';}?>>
                                <?=$value->nama_dma?></option>
                            <?php endforeach?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <?php if ($profile_pelanggan->status_pelanggan == 0): ?>
                            <option value="<?=$profile_pelanggan->status_pelanggan;?>" <?php if ($profile_pelanggan->status_pelanggan != 0) {echo 'selected';}?>><?=($profile_pelanggan->status_pelanggan) == 0 ? "Tidak Aktif" : "";?></option>
                            <option value='1'>Aktif</option>
                            <?php else: ?>
                                <option value="<?=$profile_pelanggan->status_pelanggan;?>" <?php if ($profile_pelanggan->status_pelanggan == 0) {echo 'selected';}?>><?=($profile_pelanggan->status_pelanggan) != 0 ? "Aktif" : "";?></option>
