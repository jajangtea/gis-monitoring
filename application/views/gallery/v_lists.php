							...
							foreach ($gallery as $key => $value) { ?>
								<tr>
									...
									<td class="text-center">
										...
										<button data-toggle="modal" data-target="#<?= $value->id_dma ?>" class="btn btn-success btn-flat btn-minier"><i class="fa fa-pencil"></i> Fanti Sampul</button>
									</td>
									...
									<td class="text-center">
										<a href="<?= base_url('gallery/add/' . $value->id_dma); ?>" class="btn btn-primary btn-flat btn-mini"><i class="fa fa-plus"></i> Add Foto</a>
									</td>
...
<?php foreach ($gallery as $key => $value) { ?>
	<div class="modal fade" id="<?= $value->id_dma ?>">
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				...
				<div class="modal-body">
					<?php
					echo form_open_multipart('gallery/sampul/' . $value->id_dma);
					?>
