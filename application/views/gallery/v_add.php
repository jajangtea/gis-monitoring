<div class="col-sm-12">
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			echo form_open_multipart('gallery/add/' . $kegiatan->id_dma, $atribut);
			?>
			...
			<div class="col-xs-4 col-sm-4 pricing-box">
				<div class="widget-box widget-color-grey">
					...
					<div class="widget-body">
						...
						<div>
							<button href="#" class="btn btn-success btn-minier" data-toggle="modal" data-target="#sampul<?= $kegiatan->id_dma ?>">
					...
					<div class="widget-box widget-color-grey">
						...
						<div class="widget-body">
							...
							<div>
								...
								<a href="<?= base_url('gallery/delete/' . $value->id_dma . '/' . $value->id_gallery) ?>" onclick="return confirm('Yakin Ingin Menghapus Foto ini.?')" class="btn btn-danger btn-minier">
	...
	<div class="modal fade" id="edit<?= $value->id_gallery ?>">
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				...
				<div class="modal-body">
					<?php
					echo form_open_multipart('gallery/edit/' . $value->id_dma . '/' . $value->id_gallery);
					?>
...
<div class="modal fade" id="sampul<?= $kegiatan->id_dma ?>">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
